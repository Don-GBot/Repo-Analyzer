...
async function analyzeRepo(owner, repo) {
  ...
  // Known malicious packages from crypto attacks & supply chain compromises
  const knownMalicious = {
    // npm packages
    'event-stream': 'Cryptocurrency theft - Bitcoin wallet stealer',
    'ua-parser-js': 'Cryptocurrency miner injection',
    'coa': 'Malicious code injection',
    'rc': 'Malicious code injection', 
    'colors': 'Sabotaged by maintainer - infinite loop DoS',
    'faker': 'Sabotaged by maintainer - infinite loop DoS',
    'node-ipc': 'Protestware - destructive on Russian IPs',
    'peacenotwar': 'Protestware dependency',
    'es5-ext': 'Compromised version with crypto stealer',
  ...
  const popularPackages = {
    ...
    'eslint': ['esslint', 'eslintrc', 'eslint'],
    'typescript': ['typescirpt', 'typescrypt', 'typescript-eslint'],
    // Python
  ...
  let forkScore = 5; // neutral for non-forks
